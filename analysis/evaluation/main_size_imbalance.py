...
from pipeline.preprocessing import DataStep, RepeatStep, PrepareStep, SizeImbalanceSplitStep
...
if __name__ == "__main__":
    ...
    while True:
        ...
        name = f'../../results/evaluation/{dataset}_size_imbalance_{estimators}'
